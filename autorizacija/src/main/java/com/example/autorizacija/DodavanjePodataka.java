...
public class DodavanjePodataka {
    ...
    private static final String BRISANJE_KREIRANOG_CASA = "brisanje-kreiranog-casa";
    /**
     *
     */

    private static final String EDITOVANJE_KREIRANE_ZADACE = "editovanje-kreirane-zadace";
    /**
     *
     */

    private static final String REGISTRACIJA_CASA = "registracija-casa";
    ...
    private void dodajPrivilegije() {
        ...
        privilegija1.setNazivPrivilegije(BRISANJE_KREIRANOG_CASA);
        ...
        privilegija1.setNazivPrivilegije(EDITOVANJE_KREIRANE_ZADACE);
        privilegija1.setUloge(uloga);
        if (nemaPrivilegija) {
            privilegijaRepozitorij.save(privilegija1);
        } else if (!privilegijaPostoji(svePrivilegije, privilegija1)) {
        ...
        privilegija1 = new Privilegija();
        privilegija1.setNazivPrivilegije(REGISTRACIJA_CASA);
        privilegija1.setUloge(uloga);
        if(nemaPrivilegija) {
            privilegijaRepozitorij.save(privilegija1);
        }
