...
public class DodavanjePodataka {
    ...
    private void dodajPrivilegije() {
        ...
        Privilegija pristup_dashboardu = new Privilegija();
        pristup_dashboardu.setNazivPrivilegije("pristup-dashboardu");
        editovanje_kreirane_zadace.setUloge(uloga);

        if(!privilegijaRepozitorij.existsBynazivPrivilegije("pristup-dashboardu")) privilegijaRepozitorij.save(editovanje_kreirane_zadace);
        else {
            List<Uloga> noveUloge = privilegijaRepozitorij.findBynazivPrivilegije("pristup-dashboardu").getUloge();
            ...
            if(trebaDodati){
                ...
                privilegijaRepozitorij.deleteById(privilegijaRepozitorij.findBynazivPrivilegije("pristup-dashboardu").getId());
                pristup_dashboardu.setUloge(noveUloge);
                privilegijaRepozitorij.save(pristup_dashboardu);
            }
        }
