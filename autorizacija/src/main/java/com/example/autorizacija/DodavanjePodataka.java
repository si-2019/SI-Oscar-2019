...
public class DodavanjePodataka {
    ...
    private void dodajPrivilegije() {
        ...
        privilegija2.setNazivPrivilegije("kreiranje-termina-ispita");
        privilegija2.setUloge(uloga);
        if(!privilegijaRepozitorij.existsBynazivPrivilegije("kreiranje-termina-ispita")) privilegijaRepozitorij.save(privilegija2);
