...
public class DodavanjePodataka {
    ...
    private void dodajPrivilegije() {
        ...
        Privilegija promjena_bodova_za_prisustvo = new Privilegija();
        promjena_bodova_za_prisustvo.setNazivPrivilegije("promjena-bodova-za-prisustvo");
        editovanje_kreirane_zadace.setUloge(uloga);

        if(!privilegijaRepozitorij.existsBynazivPrivilegije("promjena-bodova-za-prisustvo")) privilegijaRepozitorij.save(editovanje_kreirane_zadace);
        else {
            List<Uloga> noveUloge = privilegijaRepozitorij.findBynazivPrivilegije("promjena-bodova-za-prisustvo").getUloge();
            ...
            if(trebaDodati){
                ...
                privilegijaRepozitorij.deleteById(privilegijaRepozitorij.findBynazivPrivilegije("promjena_bodova_za_prisustvo").getId());
                promjena_bodova_za_prisustvo.setUloge(noveUloge);
                privilegijaRepozitorij.save(promjena_bodova_za_prisustvo);
            }
        }
